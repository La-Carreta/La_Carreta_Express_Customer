        ...
        children: [
            ...
            child: Row(
              ...
              children: [
                const Text("Fecha",
                    style:
                        TextStyle(fontWeight: FontWeight.w600, fontSize: 20)),
                Text(formatDate(ordenPedido.fechaEmision),
                    style: const TextStyle(
                        fontSize: 20, color: Color(0xff9D9D9D))),
              ],
            ),
          ),
          ...
          Expanded(
            ...
            itemBuilder: (context, index) {
              ...
              return FadeInDown(
                  from: 30,
                  child:
                      _ItemCartPlato(maximiunWidth: maximiunWidth, item: item));
            },
          )),
          ...
          Row(
            ...
            children: [
              ...
              Text("\$${ordenPedido.costoTotalPedido.toStringAsFixed(2)}",
                  style: const TextStyle(
