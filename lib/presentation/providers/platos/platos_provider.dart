...
final platosByCategoriaProvider = StateNotifierProvider<PlatosByCategoriaNotifier, List<Plato>>((ref){
  final fetchPlatosByCategoria = ref.watch( platoRepositoryProvider ).getPlatosByCategoria;
  return PlatosByCategoriaNotifier(fetchPlatosByCategoria: fetchPlatosByCategoria);
});
