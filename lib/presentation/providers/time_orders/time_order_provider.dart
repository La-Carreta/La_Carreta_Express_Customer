...
final timeOrderProvider = StateNotifierProvider<EstimatedTimeNotifier, EstimatedTime>((ref){
  final getTimeEstimated = ref.watch(ordenPedidoRepositoryProvider).getEstimatedTime;
  return EstimatedTimeNotifier(
    callbackOnEstimatedTime: getTimeEstimated
  );
});
...
class EstimatedTimeNotifier extends StateNotifier<EstimatedTime>{
  ...
  EstimatedTimeNotifier({
    required this.callbackOnEstimatedTime
