...
final registerFormProvider =
  ...
  final registerCustomerCallback =
      ref.watch(customerProvider.notifier).createCustomerData;

  return RegisterFormNotifier(
      registerUserCallback: registerUserCallback,
      registerCustomerCallback: registerCustomerCallback);
});
...
class RegisterFormNotifier extends StateNotifier<RegisterFormState> {
  ...
  final Function(Cliente, String) registerCustomerCallback;

  RegisterFormNotifier(
      {required this.registerUserCallback,
      required this.registerCustomerCallback})
  ...
  onFormSubmit() async {
    ...
    final String resp = await registerUserCallback(
        state.email.value, state.password.value, fullName);
    ...
    final Cliente cliente = Cliente(
      ...
      uuid: resp,
      imgUrl:
          'https://res.cloudinary.com/dwexseytn/image/upload/v1708297546/La_Carreta_Express/Avatar_users/no-profile-photo_nsgx2g.png',
    );

    await registerCustomerCallback(cliente, resp);
  }
