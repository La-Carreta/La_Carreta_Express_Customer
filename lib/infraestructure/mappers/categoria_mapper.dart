...
class CategoriaMapper{
  static Categoria categoriaToEntity(CategoriaModel categoriaModel) => Categoria(id: categoriaModel.id, nombre: categoriaModel.nombre, urlImg: categoriaModel.imgUrl);
}