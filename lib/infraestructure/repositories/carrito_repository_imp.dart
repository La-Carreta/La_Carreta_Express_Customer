...
class CarritoRepositoryImpl extends CarritoRepository {
  ...
  Future<Carrito> deleteDetallePedido(
    ...
    return datasource.deleteDetallePedido(
  ...
  Future<Carrito> updateDetallePedido(
    ...
    return datasource.updateDetallePedido(
        carrito: carrito, cantidad: cantidad, idDetalle: idDetalle);
  }
  ...
  Future<Carrito> createOrUpdateDetallePedido(
    ...
    return datasource.createOrUpdateDetallePedido(
        idCarrito: idCarrito, cliente: cliente, detallePedido: detallePedido);
  }
